CREATE TABLE survey (
       survey_id        INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY (start with 1, increment by 1),
...
--;;
CREATE TABLE site (
       site_id              INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY (start with 1, increment by 1),
...
CREATE TABLE survey_site (
       survey_site_id       INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY (start with 1, increment by 1),
...
CREATE TABLE camera_status (
       camera_status_id               INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY (start with 1, increment by 1),
...
--;;
CREATE TABLE camera (
       camera_id                INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY (start with 1, increment by 1),
...
CREATE TABLE trap_station (
       trap_station_id          INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY (start with 1, increment by 1),
...
CREATE TABLE trap_station_session (
       trap_station_session_id          INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY (start with 1, increment by 1),
...
CREATE TABLE trap_station_session_camera (
       trap_station_session_camera_id       INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY (start with 1, increment by 1),
...
--;;
CREATE TABLE media (
       media_id                         INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY (start with 1, increment by 1),
...
--;;
CREATE TABLE photo (
       photo_id                 INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY (start with 1, increment by 1),
...
CREATE TABLE species (
       species_id               INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY (start with 1, increment by 1),
...
CREATE TABLE sighting (
       sighting_id              INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY (start with 1, increment by 1),
